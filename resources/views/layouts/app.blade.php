        ...
        <nav class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <!-- Branding Image -->
                    <a class="navbar-brand" href="{{ url('/') }}" style="font-family: 'Indie Flower', cursive;">{{ $title or config('app.name') }}
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @else
                            ...
                            @if(isset($user->fields->HistóricoSetores) and $user->fields->HistóricoSetores[0] == "Call Center")
                                <li><a href="{{ url('orcamento') }}">Orçamento</a></li>
                            @endif
                            <li><a href="{{ url('/dashboard') }}">Seu Painel</a></li>
